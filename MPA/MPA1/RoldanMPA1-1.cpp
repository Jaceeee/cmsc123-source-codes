        ...
        if(tmp->type == 2){
            ...
            while(token!=NULL){
                ...
                if(token[0] == '<' || token[0] == '>'){
                    ...
                    pt1 = tmp1;
                    //printf(" Final pt1 = %s",pt1);
                    //printf(" FInal pt2 = %s",pt2);
...
void List::determineBounds(char* f1, char* f2, int operations, bool rtChk, int logChk, bool symbolChk, int compOp){
    //printf("aaaf1 = %s, f2 = %saaa rtchk = %i",f1,f2,rtChk);
    ...
    printf("asdfdsf %i %i %i %i",type,flag,flag2,symbolChk);
    if(type == 1 && rtChk == false){
        ...
        if(flag == true){
            if(flag2 == true){
                if((bound1 > bound2 && symbolChk == false) || (bound1 < bound2 && symbolChk == true)){
                    printf("T(n) = infinite\n");
                    return;
                }
                else{
                    //linearChk(rtChk,flag,flag2,bound1,bound2,operations);
                    //return;
                }
            }
            else{
    ...
    if(increment == 2 || increment == 3){
        if(increment == 2){
            if(flag2 == false){
                if(bound1 == 1){
                    printf("T(n) = %in/%i + 2", operations,logChk);
                    return;
                }
                else{
                    int g = operations * (bound1 - 1) - 2;
                    printf("T(n) = %in/%i - %i",operations,logChk, g);
                }
            }
            return;
        }
            ...
            if(flag == true){
                if(bound1 == 1){
                    printf("T(n) = %ilog (%i) n + 2",operations,logChk);
                }
                else{
    ...
    if(rtChk == false){
        if(flag == true){
            if(flag2 == true){
                if(bound1 != 1){
                    printf("T(n) = %i",operations*(bound2-bound1+1)+2);
                }
                else{
                    printf("T(n) = %i",bound2*operations+2);
                }
            }
            else{
                if(bound1 != 1){
...
void List::performCount(){
    ...
    //printf("first operations%i",operations);
...
int List::checkType(char a_String[]){
    char* token;
    ...
    while(token!=NULL){
        ...
        else if(strcmp(token, ">") == 0 || strcmp(token, "<") == 0 || strcmp(token,"==") == 0 || strcmp(token,">=")
            == 0 || strcmp(token,"<=") == 0){
            return 2;
        }
...
void linearChk(bool rtChk, bool flag, bool flag2, int bound1, int bound2, int operations){
    printf("operations == %i",operations);
    if(rtChk == false){
        if(flag == true){
            if(flag2 == true){
                if(bound1 != 1){
